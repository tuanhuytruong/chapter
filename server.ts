...
app.post("/api/auth/login", authRateLimit(authRateLimitPolicies.login(config.authRateLimitWindowMs, config.authLoginMaxAttempts)), async (req, res) => {
...
app.post("/api/auth/forgot-password", authRateLimit(authRateLimitPolicies.forgotPassword(config.authRateLimitWindowMs, config.authPasswordResetMaxAttempts)), async (req, res) => {
...
app.post("/api/auth/reset-password", authRateLimit(authRateLimitPolicies.resetPassword(config.authRateLimitWindowMs, config.authPasswordResetMaxAttempts)), async (req, res) => {
...
app.get("/api/auth/google", authRateLimit(authRateLimitPolicies.oauth(config.authRateLimitWindowMs, config.authOauthMaxAttempts)), (req, res) => {
