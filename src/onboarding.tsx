...
export function OnboardingHelp() {
  ...
  return <section className="rounded-3xl border border-natural-border bg-natural-cream p-5 shadow-sm sm:p-6"><p className="text-[10px] font-bold uppercase tracking-[0.16em] text-natural-sage">Chapter guide</p><h2 className="mt-1 text-lg font-bold text-natural-dark">How Chapter works</h2><ul className="mt-3 space-y-2 text-xs leading-relaxed text-natural-stone"><li><strong className="text-natural-dark">Add a book:</strong> choose Reading Companion for Casual or Deep Reading, or Story Thread for fiction.</li><li><strong className="text-natural-dark">Read in sessions:</strong> Chapter saves your progress first, then prepares the companion notes in the background.</li><li><strong className="text-natural-dark">Return when it helps:</strong> Review brings back key ideas; Journey reflects patterns across your reading.</li></ul><div className="mt-4 flex flex-wrap gap-2"><Link to="/help" className="inline-flex min-h-11 items-center rounded-full bg-natural-sage px-4 text-xs font-bold text-white hover:bg-natural-sage-dark">Browse the full guide</Link><button type="button" onClick={() => void reset()} className="min-h-11 rounded-full border border-natural-border px-4 text-xs font-bold text-natural-dark hover:bg-white">Show helpful tips again</button></div></section>;
}
