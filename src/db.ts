...
export async function verifyCoreSchema(): Promise<void> {
  const required = ["books", "reading_log", "uploaded_files", "review_cards", "weekly_reading_goals", "story_thread_analyses", "story_state_snapshots", "onboarding_progress", "podcasts", "subscriptions", "usage_events", "membership_prompt_state", "monthly_reviews", "ask_reading_answers"];
