      ...
      <header className="sticky top-0 z-40 border-b border-natural-border bg-natural-bg">
        <div className="mx-auto flex min-h-16 w-full max-w-7xl items-center justify-between gap-2 px-3 sm:h-20 sm:px-6 lg:px-8">
          ...
          <div className="flex shrink-0 items-center gap-1 sm:gap-2">
            ...
            <NavLink to="/account" aria-label="Account settings" className="hidden h-8 w-8 items-center justify-center rounded-full border border-natural-border bg-natural-cream text-natural-stone outline-none hover:text-natural-dark focus-visible:ring-2 focus-visible:ring-natural-sage/50 focus-visible:ring-offset-2 focus-visible:ring-offset-natural-bg sm:flex"><Settings2 className="h-3.5 w-3.5" /></NavLink>
