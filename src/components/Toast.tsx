...
export default function Toast({ toast, onClose }: { toast: { type: 'ok' | 'err'; msg: string }; onClose: () => void }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-natural-cream border border-natural-border rounded-2xl shadow-lg px-4 py-3 max-w-sm animate-[fadeIn_0.2s_ease]">
