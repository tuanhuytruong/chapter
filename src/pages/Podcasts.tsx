...
function ChapterRow({ number, chapter, creating, onCreate, onPlay }: { number: number; chapter: PodcastChapter; creating: boolean; onCreate: () => void; onPlay: () => void }) {
